...
bool MenuScene::init()
{
    ...
    cocos2d::Sprite *coinSprite=cocos2d::Sprite::create("startmenu/coins.png");
    ...
    coinSprite->setPosition(cocos2d::Point(width/ 2,height-100));
    ...
    menu = cocos2d::Menu::create(settingItem,storeItem,playItem,customizeItem,NULL);
